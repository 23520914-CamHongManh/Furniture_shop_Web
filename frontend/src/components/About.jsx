            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div className="team-member text-center">
                    ...
                    <div className="member-img">
                        ...
                        <img src={ConchoCHM} alt="Con chó Cam Hồng Mạnh" className="w-full h-full object-cover" />
                    </div>
                ...
                <div className="team-member text-center">
                     {/* CHỈNH SỬA: h-56 w-56 */}
                    <div className="member-img">
                         <img src={ConChoNhatMinh} alt="Con Chó Nhật Minh (24h)" className="w-full h-full object-cover" />
                    </div>
                ...
                <div className="team-member text-center">
                     {/* CHỈNH SỬA: h-56 w-56 */}
                    <div className="member-img">
                         <img src={ConChoJuLong} alt="Con Chó JuLong" className="w-full h-full object-cover" />
                    </div>
